...
gitGraph
    ...
    commit id: "tag: llvmorg-22.1.4"
    checkout main
    branch rust-lang/llvm-project
    commit id: "branch: rustc/22.1-2026-03-22"
    checkout llvm/llvm-project
    merge rust-lang/llvm-project id: "diff: llvmorg-22.1.4 ... rustc/22.1-2026-03-22"
    checkout llvm/llvm-project
    checkout main
    branch KomiMoe/Arkari
    commit id: "branch: llvm-22.x"
    checkout llvm/llvm-project
    merge KomiMoe/Arkari id: "diff: llvmorg-22.1.4 ... llvm-22.x"
    checkout main
    commit id: "base: llvmorg-22.1.4"
...
## Used Version
- [repo `rust-lang/llvm-project` branch `rustc/22.1-2026-03-22`](https://github.com/rust-lang/llvm-project/tree/rustc/22.1-2026-03-22)
