...
gitGraph
    ...
    commit id: "tag: llvmorg-22.1.7"
    checkout main
    branch rust-lang/llvm-project
    commit id: "branch: rustc/22.1-2026-05-19"
    checkout llvm/llvm-project
    merge rust-lang/llvm-project id: "diff: llvmorg-22.1.7 ... rustc/22.1-2026-05-19"
    checkout llvm/llvm-project
    checkout main
    branch KomiMoe/Arkari
    commit id: "branch: llvm-22.x"
    checkout llvm/llvm-project
    merge KomiMoe/Arkari id: "diff: llvmorg-22.1.7 ... llvm-22.x"
    checkout main
    commit id: "base: llvmorg-22.1.7"
...
## Used Version
- [repo `rust-lang/llvm-project` branch `rustc/22.1-2026-05-19`](https://github.com/rust-lang/llvm-project/commit/81c69e1404010ede8e16d7c975bb6e5bb17cb52c)
- [repo `komimoe/Arkari` branch `llvm-22.x`](https://github.com/komimoe/Arkari/commit/9056b853e656db75e57be0bb48c43133a73e0335)
