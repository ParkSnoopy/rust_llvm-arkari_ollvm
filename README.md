...
Merge [rust-lang/llvm-project](https://github.com/rust-lang/llvm-project) and [ParkSnoopy/Arkari](https://github.com/ParkSnoopy/Arkari) (forked from [KomiMoe/Arkari](https://github.com/KomiMoe/Arkari))
...
gitGraph
    ...
    commit id: "tag:llvmorg-22.1.0-rc2"
    checkout main
    branch KomiMoe/Arkari
    commit id: "tag:llvm-22.x"
    checkout llvm/llvm-project
    merge KomiMoe/Arkari id: "diff: llvmorg-22.1.0-rc2 ... llvm-22.x"
    checkout main
    branch rust-lang/llvm-project
    commit id: "rustc/22.1-2026-01-27"
    checkout llvm/llvm-project
    merge rust-lang/llvm-project id: "diff: llvmorg-22.1.0-rc3 ... rustc/22.1-2026-01-27"
    checkout llvm/llvm-project
    commit id: "diff: llvmorg-22.1.0-rc2 ... llvmorg-22.1.0-rc3"
    checkout main
    commit id: "base: llvmorg-22.1.0-rc2"
...
- [repo `ParkSnoopy/Arkari` tag `ollvm-22.1.0-rc2`](https://github.com/ParkSnoopy/Arkari/releases/tag/ollvm-22.1.0-rc2)
