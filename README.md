...
gitGraph
    ...
    commit id: "tag:llvmorg-21.1.5"
    checkout main
    branch rust-lang/llvm-project
    commit id: "rustc/21.1-2025-08-01"
    checkout llvm/llvm-project
    merge rust-lang/llvm-project id: "diff llvmorg-21.1.5 rustc/21.1-2025-08-01"
    checkout main
    branch ParkSnoopy/Arkari
    commit id: "branch:llvmorg-21.1.5"
    checkout llvm/llvm-project
...
- [repo `ParkSnoopy/Arkari` branch `llvmorg-21.1.5`](https://github.com/ParkSnoopy/Arkari/tree/llvmorg-21.1.5)
